...
const UUID = process.env.UUID || '6261f56a-9b0c-4577-a4a3-898e60f9096e'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'appw.faiz.us.kg';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNmI3MzZhMDhiMzlmNDVlMzE2ZTdlMGNkODE2Yjc2ZDIiLCJ0IjoiMDRlMTBjOTktNDQzMC00YmQxLTk1ZGUtNDk1NmQyMWEyMmRlIiwicyI6IlpEYzNOVFUwT0dJdFpEUTVZaTAwTlRVeUxUZzRZbVF0WWpnM04yTm1aV05sTlRjMyJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://fscarmen.cloudflare.now.cc
